...
public class CheckpointHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            String dest = "/tmp/dump.sql";

            boolean execute = ProcessRuntime.run(MySQLDump.getMySQLCheckpointCommand(host, "root", null, dest));
            response.put(Keys.EXECUTED.toString(), execute);
            response.put(Keys.RESULT.toString(), dest);
